...
const Info = () => {
  ...
  const [ headData, setHeadData ] = useState({ title: '交易记录详情', back: 'goBack', textColor: 'white' })
      ...
      <div className='assets_info_form'>
        ...
        <div className='public_w'>
          <ul className="assets_info_form_ul">
            <li><p>订单号</p><span>payment20210422195000001</span></li>
            <li><p>商户订单号</p><span>payment20210422195000001</span></li>
            <li><p>创建时间</p><span>2023-06-30 18:17:47</span></li>
            <li><p>完成时间</p><span>2023-06-30 18:17:47</span></li>
          </ul>
          <ul className="assets_info_form_ul">
            <li><p>应用</p><span>Ozbet</span></li>
            <li><p>商品说明</p><span>Ozbet充值</span></li>
            <li><p>货币类型</p><span>USDT-TRC20</span></li>
            <li><p>数量</p><span className='assets_info_form_li_money'>23</span></li>
            <li><p>状态</p><span>已完成</span></li>
          </ul>
        </div>
      </div>
    </div>
