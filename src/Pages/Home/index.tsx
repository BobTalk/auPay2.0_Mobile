    ...
    <div className='home_wrap nav_h'>
      ...
      <div className="home_banner public_w">
        ...
        <ul className='home_banner_assets'>
          <li>
            <p>
              auPay资产(USDT)
              <i onClick={ hideMoney } className={ !hide ? 'iconfont icon-chakan' : 'iconfont icon-biyan' }></i>
            </p>
      ...
      <div className="public_w">
        <div className='home_news'>
          <p>最近一笔交易记录：2020-09-17 09:29:08 充币TRX最近一笔交易记录：2020-09-17 09:29:08 充币TR…</p>
        ...
        <div className="home_notice">
          ...
          <div className="home_notice_foo">
            <p className='home_notice_foo_tit'>公告 <i className="iconfont icon-gonggaopeizhi" /></p>
            <div className='home_notice_swiper'>
              <Swiper
                indicator={() => null}
                loop
                autoplay
                direction='vertical' style={{ '--height': '20px' }}>
                <Swiper.Item><p className='home_notice_swiper_p'>公告一公告一公告一公告一公告一公告一公告一公告一公告一公告一公告一</p></Swiper.Item>
                <Swiper.Item><p className='home_notice_swiper_p'>公告2公告2公告2公告2公告2公告2公告2公告2公告2公告2公告2</p></Swiper.Item>
